...
public class All extends SubCommand {
    ...
    public boolean run(CommandSender sender, String[] args) {
        ...
        subCommandsExecutor.executeSubCommand(new Locations(), sender, null);
        subCommandsExecutor.executeSubCommand(new Players(), sender, null);
        subCommandsExecutor.executeSubCommand(new DatabaseConfig(), sender, null);
